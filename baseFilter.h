...
public:
    ...
    uint32_t** getFixedPixel() {return fixedPixelMap;}; //zwraca wskaźnik do mapy z naprawionymi pixelami

    void takePicture(short ***tabRGB, uint32_t iHeight, uint32_t iLenght);  //pobiera obrazek do naprawy
    short *** returnFixedPicture() { return picture; }; //zwraca przyjęty obraz
